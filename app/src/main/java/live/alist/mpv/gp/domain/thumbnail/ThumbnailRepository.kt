package live.alist.mpv.gp.domain.thumbnail
...
class ThumbnailRepository(
  ...
  private val appearancePreferences by lazy { 
    org.koin.java.KoinJavaComponent.get<live.alist.mpv.gp.preferences.AppearancePreferences>(
      live.alist.mpv.gp.preferences.AppearancePreferences::class.java
    ) 
  }
