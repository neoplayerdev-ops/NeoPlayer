package live.alist.mpv.gp.ui.browser.networkstreaming.proxy

import android.util.Log
import live.alist.mpv.gp.domain.network.NetworkConnection
import live.alist.mpv.gp.ui.browser.networkstreaming.clients.NetworkClient
import live.alist.mpv.gp.ui.browser.networkstreaming.clients.NetworkClientFactory
    ...
    return runBlocking {
      try {
        when (streamInfo.client) {
          is live.alist.mpv.gp.ui.browser.networkstreaming.clients.SmbClient -> {
            getFileSizeSMB(streamInfo)
          }

          is live.alist.mpv.gp.ui.browser.networkstreaming.clients.FtpClient -> {
            getFileSizeFTP(streamInfo)
          }

          is live.alist.mpv.gp.ui.browser.networkstreaming.clients.WebDavClient -> {
            val webDavClient =
              streamInfo.client as live.alist.mpv.gp.ui.browser.networkstreaming.clients.WebDavClient
            ...
            val ftpClient =
              streamInfo.client as? live.alist.mpv.gp.ui.browser.networkstreaming.clients.FtpClient
