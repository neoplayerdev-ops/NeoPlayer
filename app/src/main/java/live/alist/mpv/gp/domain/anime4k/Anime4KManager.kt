package live.alist.mpv.gp.domain.anime4k
...
class Anime4KManager(private val context: Context) {
  ...
  enum class Quality(val suffix: String, val titleRes: Int) {
    FAST("S", live.alist.mpv.gp.R.string.anime4k_quality_fast),
    BALANCED("M", live.alist.mpv.gp.R.string.anime4k_quality_balanced),
    HIGH("L", live.alist.mpv.gp.R.string.anime4k_quality_high)
  }

  // Anime4K modes
  enum class Mode(val titleRes: Int) {
    OFF(live.alist.mpv.gp.R.string.anime4k_mode_off),
    A(live.alist.mpv.gp.R.string.anime4k_mode_a),
    B(live.alist.mpv.gp.R.string.anime4k_mode_b),
    C(live.alist.mpv.gp.R.string.anime4k_mode_c),
    A_PLUS(live.alist.mpv.gp.R.string.anime4k_mode_a_plus),
    B_PLUS(live.alist.mpv.gp.R.string.anime4k_mode_b_plus),
    C_PLUS(live.alist.mpv.gp.R.string.anime4k_mode_c_plus)
  }
