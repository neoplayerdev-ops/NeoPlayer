...
import live.alist.mpv.gp.database.repository.PlaybackStateRepositoryImpl
import live.alist.mpv.gp.database.repository.PlaylistRepository
import live.alist.mpv.gp.database.repository.RecentlyPlayedRepositoryImpl
import live.alist.mpv.gp.domain.playbackstate.repository.PlaybackStateRepository
import live.alist.mpv.gp.domain.recentlyplayed.repository.RecentlyPlayedRepository
...
val DatabaseModule =
  module {
    ...
    single {
      live.alist.mpv.gp.database.repository.VideoMetadataCacheRepository(
    ...
    single {
      live.alist.mpv.gp.repository.NetworkRepository(
        dao = get(),
      )
    }
