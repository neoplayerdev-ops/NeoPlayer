package live.alist.mpv.gp.ui.browser.folderlist
...
import live.alist.mpv.gp.domain.media.model.VideoFolder
import live.alist.mpv.gp.preferences.AppearancePreferences
import live.alist.mpv.gp.preferences.BrowserPreferences
import live.alist.mpv.gp.preferences.FolderSortType
import live.alist.mpv.gp.preferences.FolderViewMode
...
import live.alist.mpv.gp.preferences.SortOrder
...
import live.alist.mpv.gp.ui.browser.LocalNavigationBarHeight
...
import live.alist.mpv.gp.ui.browser.dialogs.GridColumnSelector
...
import live.alist.mpv.gp.ui.browser.filesystem.FileSystemDirectoryScreen
import live.alist.mpv.gp.ui.browser.filesystem.FileSystemBrowserRootScreen
...
object FolderListScreen : Screen {
  ...
  private fun MediaStoreFolderListContent() {
    ...
    val advancedPreferences = koinInject<live.alist.mpv.gp.preferences.AdvancedPreferences>()
  ...
  val folderGridColumns = if (isLandscape) folderGridColumnsLandscape else folderGridColumnsPortrait
    ...
    val selectionManager = rememberSelectionManager(
      ...
      onDeleteItems = { folders, _ ->
        ...
        val videos = live.alist.mpv.gp.repository.MediaFileRepository.getVideosForBuckets(context, ids)
    ...
    LaunchedEffect(permissionState.status) {
      live.alist.mpv.gp.ui.browser.MainScreen.updatePermissionState(
    ...
    Scaffold(
      topBar = {
        if (isSearching) {
          ...
          BrowserTopBar(
            title = stringResource(live.alist.mpv.gp.R.string.app_name),
            ...
            onShareClick = {
              coroutineScope.launch {
                ...
                val allVideos = live.alist.mpv.gp.repository.MediaFileRepository
            ...
            onBlacklistClick = {
              coroutineScope.launch {
                ...
                android.widget.Toast.makeText(
                  context,
                  context.getString(live.alist.mpv.gp.R.string.pref_folders_blacklisted),
            ...
            TooltipBox(
              ...
              ToggleFloatingActionButton(
                modifier = Modifier.animateFloatingActionButton(
                  visible = !selectionManager.isInSelectionMode && isFabVisible.value && !live.alist.mpv.gp.ui.browser.MainScreen.getPermissionDeniedState(),
                ...
                if (isSearchLoading) {
                  ...
                  SearchResultsContent(
                    ...
                    onFolderClick = { folder ->
                      backstack.add(live.alist.mpv.gp.ui.browser.videolist.VideoListScreen(folder.bucketId, folder.name))
                    },
                    onVideoClick = { video ->
...
private fun FolderListContent(
  ...
  foldersWithNewCount: List<live.alist.mpv.gp.ui.browser.folderlist.FolderWithNewCount>,
  ...
  selectionManager: live.alist.mpv.gp.ui.browser.selection.SelectionManager<VideoFolder, String>,
...
private fun SearchResultsContent(
  ...
  navigationBarHeight: androidx.compose.ui.unit.Dp,
  onFolderClick: (live.alist.mpv.gp.domain.media.model.VideoFolder) -> Unit,
  onVideoClick: (live.alist.mpv.gp.domain.media.model.Video) -> Unit,
  mediaLayoutMode: live.alist.mpv.gp.preferences.MediaLayoutMode,
  folderGridColumns: Int,
) {
  val folders = searchResults.filterIsInstance<FileSystemItem.Folder>().map { folder ->
    live.alist.mpv.gp.domain.media.model.VideoFolder(
  ...
  val isGridMode = mediaLayoutMode == live.alist.mpv.gp.preferences.MediaLayoutMode.GRID
...
private suspend fun searchFoldersAndVideos(
  ...
  try {
    ...
    val folders = live.alist.mpv.gp.repository.MediaFileRepository
    ...
    folders.forEach { folder ->
      ...
      val videos = live.alist.mpv.gp.repository.MediaFileRepository
